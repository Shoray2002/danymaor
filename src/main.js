...
function init() {
  ...
  const mesh = new THREE.Mesh(
    ...
    new THREE.MeshPhongMaterial({ color: 0x6d9ec8, side: THREE.DoubleSide })
  );
  ...
  model.load("../assets/apartment.fbx", function (object) {
    ...
    object.traverse(function (child) {
      if (child.isMesh) {
        ...
        child.material.side = THREE.DoubleSide; // making the texture visible from both sides of the model surface
      }
    });
